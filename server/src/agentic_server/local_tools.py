...
from agentic_server.capability_index import build_capability_index
from agentic_server.capability_manifest import load_capability_manifests, manifest_env_names
from agentic_server.flow_runtime import detect_flows, recommend_flow
from agentic_server.pdk_index import build_pdk_index
from agentic_server.tool_adapters import adapter_command_names, capability_matrix, license_env_names
from agentic_server.vlsi_capability_graph import build_capability_graph
...
def _register_background_job(
    ...
    try:
        from agentic_server.job_queue import get_job_queue
        jq = get_job_queue()
        jq.submit(
