...
from agentic_server.context_cache import build_role_context_packet
from agentic_server.vlsi_state import DesignStateStore
from agentic_server.vlsi_capability_graph import compact_capability_graph
...
def build_agent_context_packet(
    ...
    from agentic_server.flow_discovery import discover_flow, format_flow_context_prompt
