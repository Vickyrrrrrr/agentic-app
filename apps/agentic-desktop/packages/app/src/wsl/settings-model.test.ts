...
describe("WSL server settings presentation", () => {
  ...
  test("offers install and update only when the AgentIC runtime needs attention", () => {
  ...
  test("probes the selected distro before entering the runtime step", async () => {
    const calls: string[] = []
