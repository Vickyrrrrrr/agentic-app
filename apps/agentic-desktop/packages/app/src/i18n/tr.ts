...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "AgentIC tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve AgentIC'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "AgentIC Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve AgentIC'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak AgentIC'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler AgentIC runtime config içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi AgentIC sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "AgentIC'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı AgentIC ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (AgentIC runtime config) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: AgentIC henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "AgentIC ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "settings.desktop.wsl.description": "AgentIC sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "AgentIC'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "AgentIC'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "AgentIC'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "AgentIC'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "AgentIC başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "AgentIC'un en son sürümünü kullanıyorsunuz.",
