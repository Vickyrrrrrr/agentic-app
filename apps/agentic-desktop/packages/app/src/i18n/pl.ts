export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez AgentIC",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w AgentIC.",
  ...
  "provider.connect.opencodeZen.line1":
    "AgentIC Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w AgentIC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w AgentIC.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w AgentIC runtime config",
  ...
  "dialog.server.description": "Przełącz serwer AgentIC, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja AgentIC ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu AgentIC",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (AgentIC runtime config) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "AgentIC zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Run the AgentIC server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla AgentIC",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd AgentIC na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy AgentIC ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw AgentIC.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania AgentIC",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji AgentIC.",
