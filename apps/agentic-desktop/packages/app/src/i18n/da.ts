export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af AgentIC",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i AgentIC.",
  ...
  "provider.connect.opencodeZen.line1":
    "AgentIC Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i AgentIC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i AgentIC.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i AgentIC runtime config",
  ...
  "dialog.server.description": "Skift hvilken AgentIC-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af AgentIC ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til AgentIC-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (AgentIC runtime config) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, AgentIC understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "AgentIC inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør AgentIC-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for AgentIC",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan AgentIC ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om AgentIC følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan AgentIC er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når AgentIC starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af AgentIC.",
