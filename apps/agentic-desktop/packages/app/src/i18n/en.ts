export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by AgentIC",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in AgentIC.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "AgentIC Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.opencodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.opencodeZen.visit.prefix": "Visit ",
  "provider.connect.opencodeZen.visit.link": "www.buildstack.live/agentic",
  "provider.connect.opencodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in AgentIC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in AgentIC.",
  ...
  "dialog.plugins.empty": "Plugins configured in AgentIC runtime config",
  ...
  "dialog.server.description": "Switch which AgentIC server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "AgentIC",
  ...
  "wsl.onboarding.checkingOpencode": "Checking AgentIC...",
  "wsl.onboarding.checkingOpencodeIn": "Checking AgentIC in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating AgentIC...",
  "wsl.onboarding.updatingOpencodeIn": "Updating AgentIC in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update AgentIC in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update AgentIC",
  "wsl.onboarding.opencodeReadyIn": "AgentIC is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentIC is ready.",
  "wsl.onboarding.installOpencodeIn": "Install AgentIC in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install AgentIC",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen AgentIC.",
  ...
  "toast.update.description": "A new version of AgentIC ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the AgentIC team",
  ...
  "error.chain.checkConfig": "Check your config (AgentIC runtime config) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, AgentIC does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "AgentIC includes free models so you can start immediately.",
  ...
  "app.name.desktop": "AgentIC Desktop",
  ...
  "settings.desktop.wsl.description": "Run the AgentIC runtime inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for AgentIC",
  ...
  "settings.general.row.appearance.description": "Customise how AgentIC looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether AgentIC follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how AgentIC is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when AgentIC launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of AgentIC.",
